...
- Display dependency name on parsing errors of `shards.yml`. ([#408](https://github.com/crystal-lang/shards/pull/408), thanks @straight-shoota)
- Handle ambiguous dependencies and update `shard.lock` if source of dependency change. ([#419](https://github.com/crystal-lang/shards/pull/419), thanks @bcardiff)
- Reinstall when resolver changes. ([#425](https://github.com/crystal-lang/shards/pull/425), thanks @waj)

Features:

- Shards overrides. ([#422](https://github.com/crystal-lang/shards/pull/422), thanks @bcardiff)

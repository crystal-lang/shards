...
module Shards
  ...
  describe GitResolver, tags: %w[git] do
    ...
    it "normalizes github bitbucket gitlab sources" do
      ...
      GitResolver.normalize_key_source("git", "HTTPS://User:Pass@tangled.org/Repo/Path.Git?Shallow=true")[1].should eq "https://User:Pass@tangled.org/repo/path.git?Shallow=true"
